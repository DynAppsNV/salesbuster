...
class SaleOrder(models.Model):
        ...
        for order_counter, channel_order in enumerate(channel_orders, 1):
            ...
            try:
                data = {
                    ...
                    "Lines": order_lines,
                    "TrackTraceNo": tracking_number_list and tracking_number_list[0],
                    "Method": carrier_name
                }
    ...
    def action_confirm(self):
        ...
        for order in self.filtered(lambda o: o.state == 'sale' and o.channel_order_no \
            ...
            for order_counter, sale_order in enumerate(sale_orders, 1):
                ...
                if results.status_code == 200:
                    ...
                    try:
                        ...
                        # raise Warning("1. Response: %s \n2.Response Status: %s \n3. Error: %s" % (results,results.status_code,e))
                        results_response = {
